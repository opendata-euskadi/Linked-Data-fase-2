...
public abstract class NORA2GRAPHDBConfig  {
	...
	public final static String NORANamedGraphURI = "https://id.euskadi.eus/graph/NORA";
	public final static String NORALinksNamedGraphURI = "https://id.euskadi.eus/graph/NORA-links";
	public final static String NORAVocabsNamedGraphURI = "https://id.euskadi.eus/graph/NORA-vocabs";
	public final static String NORAMetadataGraphURI = "https://id.euskadi.eus/graph/NORA-metadata";
